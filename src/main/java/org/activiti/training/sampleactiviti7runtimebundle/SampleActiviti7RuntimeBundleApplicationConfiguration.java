...
@Configuration
public class SampleActiviti7RuntimeBundleApplicationConfiguration {

    private final Logger logger = LoggerFactory.getLogger(SampleActiviti7RuntimeBundleApplicationConfiguration.class);
